...
// const beautyBeastClothing = require(`./beauty&beast`);
// ClothingData.push(beautyBeastClothing);
...
const NewClothingData = Array.prototype.concat.apply([], ClothingData);

return NewClothingData
}
console.log(getClothingData())

module.exports = getClothingData;